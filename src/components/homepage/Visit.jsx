...
const Visit = () => {
  return (
    <section
      id="visit"
      className="bg-white w-full min-h-screen flex items-center justify-center px-6 md:px-24 py-10 md:py-20"
    >
      <div className="flex flex-col md:flex-row-reverse items-center justify-between gap-12 w-full max-w-7xl">
        ...
        <img
          src={tokoImage}
          alt="Toko Jajanin"
          className="w-full md:w-[520px] h-auto object-cover rounded-3xl shadow-2xl"
        />

        {/* Teks */}
        <div className="flex flex-col justify-center items-start text-left w-full md:w-1/2">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-6 text-orange-500 drop-shadow-lg">
            KUNJUNGI TOKO KAMI!
          </h2>
          ...
          <div className="mb-8">
            <span className="block text-base md:text-lg font-semibold text-gray-700 mb-2">
              Jam Buka:
            </span>
